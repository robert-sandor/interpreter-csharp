...
namespace InterpreterCSharpGUIFinal
{
	public partial class TextDialog
	{
		...
		protected virtual void Build ()
		{
			...
			// Widget InterpreterCSharpGUIFinal.TextDialog
			this.Name = "InterpreterCSharpGUIFinal.TextDialog";
			this.WindowPosition = ((global::Gtk.WindowPosition)(4));
			// Internal child InterpreterCSharpGUIFinal.TextDialog.VBox
			...
			this.label.LabelProp = global::Mono.Unix.Catalog.GetString ("label4");
			...
			global::Gtk.Box.BoxChild w3 = ((global::Gtk.Box.BoxChild)(this.hbox2 [this.entry]));
			w3.Position = 1;
			w1.Add (this.hbox2);
			...
			w4.Expand = false;
			w4.Fill = false;
			// Internal child InterpreterCSharpGUIFinal.TextDialog.ActionArea
